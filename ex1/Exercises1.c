#define _CRT_SECURE_NO_WARNINGS // xóa bỏ dòng này nếu không dùng visual studio
#include <stdio.h>

/*
* Bài tập đọc ghi file text số 1
...
void sort(int* a, int n) {
	// khai báo nguyên mẫu nội bộ cho hàm sort
...
// hàm tráo đối hai phần tử kiểu nguyên
void swap(int* a, int* b) {
	int tmp = *a;
	*a = *b;
	*b = tmp;
